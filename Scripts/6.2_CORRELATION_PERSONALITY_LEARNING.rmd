...
load("../Models/predator_learning_control.Rdata")
load("../Models/aggression_learning_control.Rdata")
load("../Models/social_learning_control.Rdata")
load("../Models/novel_learning_control.Rdata")
load("../Models/activity_learning_control.Rdata")

load("../Models/predator_learning_treatment.Rdata")
load("../Models/aggression_learning_treatment.Rdata")
load("../Models/social_learning_treatment.Rdata")
load("../Models/novel_learning_treatment.Rdata")
load("../Models/activity_learning_treatment.Rdata")
```
