...
Model_Tot_Dist <- lmer(tot_dist ~ Group + Sex + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
...
rpt_tot_dist(Weight_Length_Control) -> Control_Tot_Dist #repeatability for short tanks
rpt_tot_dist(Weight_Length_Treatment) -> Treatment_Tot_Dist #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_tot_dist(Weight_Length_Control) -> within_between_tot_dist_control #Short tanks
rpt_within_between_tot_dist(Weight_Length_Treatment)-> within_between_tot_dist_treatment #Tall tanks
...
hist(residuals(Model_low_dur)) #histogram of residuals to check for normal distribution (easiest way to check assumption of normality)


#Calculating repeatabilities using custom made functions
rpt_low_dur(Weight_Length_Control) -> Control_low_dur #repeatability for short tanks
rpt_low_dur(Weight_Length_Treatment) -> Treatment_low_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_low_dur(Weight_Length_Control) -> within_between_low_dur_control #Short tanks
rpt_within_between_low_dur(Weight_Length_Treatment)-> within_between_low_dur_treatment #Tall tanks
...
hist(residuals(Model_mid_dur)) #histogram of residuals to check for normal distribution (easiest way to check assumption of normality)


#Calculating repeatabilities using custom made functions
rpt_mid_dur(Weight_Length_Control) -> Control_mid_dur #repeatability for short tanks
rpt_mid_dur(Weight_Length_Treatment) -> Treatment_mid_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_mid_dur(Weight_Length_Control) -> within_between_mid_dur_control #Short tanks
rpt_within_between_mid_dur(Weight_Length_Treatment)-> within_between_mid_dur_treatment #Tall tanks
...
hist(residuals(Model_high_dur)) #histogram of residuals to check for normal distribution (easiest way to check assumption of normality)


#Calculating repeatabilities using custom made functions
rpt_high_dur(Weight_Length_Control) -> Control_high_dur #repeatability for short tanks
rpt_high_dur(Weight_Length_Treatment) -> Treatment_high_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_high_dur(Weight_Length_Control) -> within_between_high_dur_control #Short tanks
rpt_within_between_high_dur(Weight_Length_Treatment)-> within_between_high_dur_treatment #Tall tanks
...
hist(residuals(Model_freezing_dur)) #histogram of residuals to check for normal distribution (easiest way to check assumption of normality)


#Calculating repeatabilities using custom made functions
rpt_freezing_dur(Weight_Length_Control) -> Control_freezing_dur #repeatability for short tanks
rpt_freezing_dur(Weight_Length_Treatment) -> Treatment_freezing_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_freezing_dur(Weight_Length_Control) -> within_between_freezing_dur_control 
rpt_within_between_freezing_dur(Weight_Length_Treatment)-> within_between_freezing_dur_treatment #
...
# Calculating difference in variance between short tanks and tall tanks 
Model_freezing_dur1 <- lme(freezing_dur ~ Group-1 + Sex, random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
summary(Model_freezing_dur1)
Model_freezing_dur2 <- lme(freezing_dur ~ Group-1 + Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent
...
#Calculating repeatabilities using custom made functions
rpt_latency_high(Weight_Length_Control) -> Control_latency_high #repeatability for short tanks
rpt_latency_high(Weight_Length_Treatment) -> Treatment_latency_high #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_latency_high(Weight_Length_Control) -> within_between_latency_high_control #Short tanks
rpt_within_between_latency_high(Weight_Length_Treatment)-> within_between_latency_high_treatment #Tall tanks
...
hist(residuals(Model_freq_high)) #histogram of residuals to check for normal distribution (easiest way to check assumption of normality)


#Calculating repeatabilities using custom made functions
rpt_freq_high(Weight_Length_Control) -> Control_freq_high #repeatability for short tanks
rpt_freq_high(Weight_Length_Treatment) -> Treatment_freq_high #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_freq_high(Weight_Length_Control) -> within_between_freq_high_control #Short tanks
rpt_within_between_freq_high(Weight_Length_Treatment)-> within_between_freq_high_treatment #Tall tanks
...
# Calculating difference in variance between short tanks and tall tanks 
Model_freq_high1 <- lme(freq_high ~ Group-1 + Sex, random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
summary(Model_freq_high1)
Model_freq_high2 <- lme(freq_high ~ Group-1 + Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent
