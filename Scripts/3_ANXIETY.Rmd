...
rpt_within_between_tot_dist(Anxiety_Control) -> within_between_tot_dist_control #Short tanks
rpt_within_between_tot_dist(Anxiety_Treatment)-> within_between_tot_dist_treatment #Tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_low_dur(Anxiety_Control) -> Control_low_dur #repeatability for short tanks
rpt_low_dur(Anxiety_Treatment) -> Treatment_low_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_low_dur(Anxiety_Control) -> within_between_low_dur_control #Short tanks
rpt_within_between_low_dur(Anxiety_Treatment)-> within_between_low_dur_treatment #Tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_mid_dur(Anxiety_Control) -> Control_mid_dur #repeatability for short tanks
rpt_mid_dur(Anxiety_Treatment) -> Treatment_mid_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_mid_dur(Anxiety_Control) -> within_between_mid_dur_control #Short tanks
rpt_within_between_mid_dur(Anxiety_Treatment)-> within_between_mid_dur_treatment #Tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_high_dur2(Anxiety_Control) -> Control_high_dur #repeatability for short tanks
rpt_high_dur2(Anxiety_Treatment) -> Treatment_high_dur #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_high_dur2(Anxiety_Control) -> within_between_high_dur_control #Short tanks
rpt_within_between_high_dur2(Anxiety_Treatment)-> within_between_high_dur_treatment #Tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_freezing_dur(Anxiety_Control) -> Control_freezing_dur #repeatability for short tanks
rpt_freezing_dur(Anxiety_Treatment) -> Treatment_freezing_dur #repeatability for tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_latency(Anxiety_Control) -> Control_latency_high #repeatability for short tanks
rpt_latency(Anxiety_Treatment) -> Treatment_latency_high #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_latency(Anxiety_Control) -> within_between_latency_high_control #Short tanks
rpt_within_between_latency(Anxiety_Treatment)-> within_between_latency_high_treatment #Tall tanks
...
#Calculating repeatabilities using custom made functions
rpt_freq(Anxiety_Control) -> Control_freq_high #repeatability for short tanks
rpt_freq(Anxiety_Treatment) -> Treatment_freq_high #repeatability for tall tanks


#Obtaining within-individual and between-individual variance for total distace 

rpt_within_between_freq_high(Anxiety_Control) -> within_between_freq_high_control #Short tanks
rpt_within_between_freq_high(Anxiety_Treatment)-> within_between_freq_high_treatment #Tall tanks
