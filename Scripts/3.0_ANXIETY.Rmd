...
Model_Tot_Dist <- lmer(tot_dist ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined)
...
Model_Tot_Dist1 <- lme(tot_dist ~ Group-1 + Sex + Water_ID, random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
summary(Model_Tot_Dist1) 
Model_Tot_Dist2 <- lme(tot_dist ~ Group-1 + Sex + Water_ID, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent
...
Model_low_dur <- lmer(low_dur ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined)
...
Model_low_dur1 <- lme(low_dur ~ Group + Sex, random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
...
Model_mid_dur <- lmer(mid_dur ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined)
...
# Calculating difference in variance between  and  
Model_mid_dur1 <- lme(mid_dur ~ Group + Sex, random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
summary(Model_mid_dur1)
Model_mid_dur2 <- lme(mid_dur ~ Group + Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent
...
Model_high_dur <- lmer(high_dur ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
...
Model_freezing_dur <- lmer(freezing_dur ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
...
Model_freezing_dur0 <- lmer(log(freezing_dur+1) ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
...
Model_latency_high <- lmer(latency_high ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
...
Model_freq_high <- lmer(freq_high ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined) #mixed model 
hist(residuals(Model_freq_high)) #histogram of residuals reveals a transformation is required

Model_freq_high0 <- lmer(sqrt(freq_high) ~ Group + Sex + Water_ID + (1 | Fish_ID), data = Anxiety_Joined)
