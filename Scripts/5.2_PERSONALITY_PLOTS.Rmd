...
social_violin2 <- violin_plot_custom_hamza2(Social_ALL,Social_ALL$tot_dist,"Total distance travelled", "CM") %>% +facet_grid(~Sex)
social_violin2
...
aggression_violin2 <- violin_plot_custom_hamza2(Aggression_ALL, Aggression_ALL$tot_dist, "Total distance travelled", "CM")%>% +facet_grid(~Sex)
aggression_violin2
