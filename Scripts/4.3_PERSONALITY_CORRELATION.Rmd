...
pacman::p_load(dplyr, brms, stringr, ggplot2, ggpubr, coda, patchwork)
...
NOTE: Novel HAS ALREADY BEEN sqrt transformed IN SAVED MODELS
...
#NOVEL WAS SQRT TRANSFORMED USING SEPARATE FUNCTION
...
#Summary of models
summary(example_Novel_Predator_control)
summary(example_Social_Aggression_control)
summary(example_Aggression_Activity_control)
summary(example_Aggression_Novel_control)
summary(example_Aggression_Predator_control)
summary(example_Novel_Activity_control)
summary(example_Predator_Activity_control)
summary(example_Social_Activity_control)
summary(example_Social_Novel_control)
summary(example_Social_Predator_control)

#Summary Plots

bivar_combined_control$behav_syndrome <- paste0(bivar_combined_control$behaviour1, " vs. ", bivar_combined_control$behaviour2)#Add a new column to name he behavioral syndrome
...
#Density plots with CI for signif syndromes
#Step 1: Subset data
Aggression_Activity_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Aggression vs. Activity")
Aggression_Novel_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Aggression vs. Novel")
Aggression_Predator_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Aggression vs. Predator")
Novel_Activity_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Novel vs. Activity")
Novel_Predator_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Novel vs. Predator")
Predator_Activity_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Predator vs. Activity")
Social_Activity_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Social vs. Activity")
Social_Aggression_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Social vs. Aggression")
Social_Novel_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Social vs. Novel")
Social_Predator_control <- subset(bivar_combined_control, bivar_combined_control$behav_syndrome == "Social vs. Predator")

#Step 2: Function for plot
...
p1 <- density_plot_bivar(Aggression_Activity_control)+
  labs(title = "Aggression vs. Exploration")
p2 <- density_plot_bivar(Aggression_Novel_control)+
  labs(title = "Aggression vs. Neophobia")
p3 <- density_plot_bivar(Aggression_Predator_control)+
  labs(title = "Aggression vs. Boldness")
p4 <- density_plot_bivar(Novel_Activity_control)+
  labs(title = "Neophobia vs. Exploration")
p5 <- density_plot_bivar(Novel_Predator_control)+
  labs(title = "Neophobia vs. Boldness")
p6 <- density_plot_bivar(Predator_Activity_control)+
  labs(title = "Boldness vs. Exploration")
p7 <- density_plot_bivar(Social_Activity_control)+
  labs(title = "Socialbility vs. Exploration")
p8 <- density_plot_bivar(Social_Aggression_control)+
  labs(title = "Sociability vs. Aggression")
p9 <- density_plot_bivar(Social_Novel_control)+
  labs(title = "Sociability vs. Neophobia")
p10 <- density_plot_bivar(Social_Predator_control)+
  labs(title = "Sociability vs. Boldness")

#Joining plots

p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 + p9 + p10 + plot_layout(ncol = 4, nrow = 4)
...
summary(example_Aggression_Activity_treatment)
summary(example_Aggression_Novel_treatment)
summary(example_Aggression_Predator_treatment)
summary(example_Novel_Activity_treatment)
summary(example_Novel_Predator_treatment)
summary(example_Predator_Activity_treatment)
summary(example_Social_Activity_treatment)
summary(example_Social_Aggression_treatment)
summary(example_Social_Novel_treatment)
summary(example_Social_Predator_treatment)

#Subsetting and plotting 

Aggression_Activity_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Aggression vs. Activity")
Aggression_Novel_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Aggression vs. Novel")
Aggression_Predator_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Aggression vs. Predator")
Novel_Activity_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Novel vs. Activity")
Novel_Predator_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Novel vs. Predator")
Predator_Activity_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Predator vs. Activity")
Social_Activity_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Social vs. Activity")
Social_Aggression_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Social vs. Aggression")
Social_Novel_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Social vs. Novel")
Social_Predator_treatment <- subset(bivar_combined_treatment, bivar_combined_treatment$behav_syndrome == "Social vs. Predator")

#Density plots

p11 <- density_plot_bivar(Aggression_Activity_treatment)+
  labs(title = "Aggression vs. Exploration")
p12 <- density_plot_bivar(Aggression_Novel_treatment)+
  labs(title = "Aggression vs. Neophobia")
p13 <- density_plot_bivar(Aggression_Predator_treatment)+
  labs(title = "Aggression vs. Boldness")
p14 <- density_plot_bivar(Novel_Activity_treatment)+
  labs(title = "Neophobia vs. Exploration")
p15 <- density_plot_bivar(Novel_Predator_treatment)+
  labs(title = "Neophobia vs. Boldness")
p16 <- density_plot_bivar(Predator_Activity_treatment)+
  labs(title = "Boldness vs. Exploration")
p17 <- density_plot_bivar(Social_Activity_treatment)+
  labs(title = "Socialbility vs. Exploration")
p18 <- density_plot_bivar(Social_Aggression_treatment)+
  labs(title = "Sociability vs. Aggression")
p19 <- density_plot_bivar(Social_Novel_treatment)+
  labs(title = "Sociability vs. Neophobia")
p20 <- density_plot_bivar(Social_Predator_treatment)+
  labs(title = "Sociability vs. Boldness")

#Joining plots

p11 + p12 + p13 + p14 + p15 + p16 + p17 + p18 + p19 + p20 + plot_layout(ncol = 4, nrow = 4)
