...
Tot_Dist_rptr_F0 <- tibble(
  Group = c("Control", "Treatment", "Contrast", "Between-Individual Variance (Control)", "Within-Individual Variance (Control)","Between-Individual Variance (Treatment)", "Within-Individual Variance (Treatment)"),
