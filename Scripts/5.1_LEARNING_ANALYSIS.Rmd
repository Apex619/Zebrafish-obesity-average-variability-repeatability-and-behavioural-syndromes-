...
load("../Models/within_between_learning_control.Rdata")
load("../Models/within_between_learning_treatment.Rdata")
load("../Models/rpt_learning_control_male.Rdata")
load("../Models/rpt_learning_treatment_male.Rdata")
load("../Models/rpt_learning_control_female.Rdata")
load("../Models/rpt_learning_treatment_female.Rdata")
load("../Models/within_between_learning_control_male.Rdata")
load("../Models/within_between_learning_treatment_male.Rdata")
load("../Models/within_between_learning_control_female.Rdata")
load("../Models/within_between_learning_treatment_female.Rdata")
```
...
# save(rpt_learning_control, file = "../Models/rpt_learning_control.Rdata")
# rpt_learning_control
# rpt_learning(Learning_Treatment) -> rpt_learning_treatment
# save(rpt_learning_treatment, file = "../Models/rpt_learning_treatment.Rdata")
...
# save(within_between_learning_control, file = "../Models/within_between_learning_control.Rdata")
# within_between_learning_control
# rpt_within_learning(Learning_Treatment) -> within_between_learning_treatment
# save(within_between_learning_treatment, file = "../Models/within_between_learning_treatment.Rdata")
...
contrasts_learning <- emmeans(Model_Learning1, c("set", "sex"))
pairs(contrasts_learning)
...
# save(rpt_learning_control_male, file = "../Models/rpt_learning_control_male.Rdata")
# rpt_learning_control_male
# rpt_learning(Treatment_Male_Learning) -> rpt_learning_treatment_male
# save(rpt_learning_treatment_male, file = "../Models/rpt_learning_treatment_male.Rdata")
...
# save(rpt_learning_control_female, file = "../Models/rpt_learning_control_female.Rdata")
# rpt_learning_control_female
# rpt_learning(Treatment_Female_Learning) -> rpt_learning_treatment_female
# save(rpt_learning_treatment_female, file = "../Models/rpt_learning_treatment_female.Rdata")
...
# save(within_between_learning_control_male, file = "../Models/within_between_learning_control_male.Rdata")
# within_between_learning_control_male
# rpt_within_learning(Treatment_Male_Learning) -> within_between_learning_treatment_male
# save(within_between_learning_treatment_male, file = "../Models/within_between_learning_treatment_male.Rdata")
...
# save(within_between_learning_control_female, file = "../Models/within_between_learning_control_female.Rdata")
...
# save(within_between_learning_treatment_female, file = "../Models/within_between_learning_treatment_female.Rdata")
