...
rpt_weight(Weight_Length_Control) -> rpt_body_weight_control
rpt_weight(Weight_Length_Treatment) -> rpt_body_weight_treatment
...
#Calculating repeatabilities using custom made functions
rpt_length(Weight_Length_Control) -> rpt_length_control
rpt_length(Weight_Length_Treatment) -> rpt_length_treatment
