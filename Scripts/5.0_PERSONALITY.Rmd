...
df_pop <- data.frame (control_female, control_male,  control_male_minus_control_female, treatment_female, treatment_male, treatment_male_minus_treatment_female,rpt_control, rpt_treatment, rpt_control_minus_rpt_treatment,correlation_control, correlation_treatment, correlation_control_minus_correlation_treatment)
...
data$coef <- (row.names(data))
data$behavior <- behav
data$coef <- factor(data$coef, levels = c("control_female", "control_male",  "control_male_minus_control_female", "treatment_female", "treatment_male",  "treatment_male_minus_treatment_female","rpt_control", "rpt_treatment", "rpt_control_minus_rpt_treatment","correlation_control", "correlation_treatment", "correlation_control_minus_corelation_treatment"))
...
Contrasts_personality_plots <- 
  ...
  coord_flip() +
  facet_grid( ~ behavior, scales = "free_x") +
