...
rpt_resids <- bind_rows(lapply(behavs, function(x) func_behav_raw(x)))
...
# do this for all behaviours and chosen variables 

func_behav_sqrt("Social")
func_behav_sqrt("Novel")
func_behav_sqrt("Aggression")
func_behav_sqrt("Predator")
