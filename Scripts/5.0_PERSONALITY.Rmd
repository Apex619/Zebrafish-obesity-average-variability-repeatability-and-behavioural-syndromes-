...
Model_post <- lmer(dist.center.point.Total.cm ~ Group + Sex + (1 |Fish_ID), data = Post_assay) 
...
# zone_05_dur and zone_near_dur there for 3/4
...
# log transformations seem to display better normal distributions for he zone05 variable
