...
#Using lapply to use function for our chosen behaviors
...
#Function for (1) the posterior distributions of population parameters
...
mod_list_brms_fit_post <- func_brm_fit_post(mod_list_brms)

# Function for (2) the fitted and predicted values for posterior means.
```
