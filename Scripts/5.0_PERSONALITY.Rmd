...
#Example of plot from model
Social_Predator_cor <- posterior_samples(example_Social_Predator)[,11]
par(mar=c(2, 2, 3, 2))
plot(density(Social_Predator_cor),
main="Correlation Social - Predator",
xlab="",ylab="",cex.main=0.8)
abline(v=0,col="red",lwd=2)
abline(v=mean(Dist_RT),col="black",lwd=2)
abline(v=HPDinterval(as.mcmc(Dist_RT))[1],col="black",lty=2)
abline(v=HPDinterval(as.mcmc(Dist_RT))[2],col="black",lty=2)
