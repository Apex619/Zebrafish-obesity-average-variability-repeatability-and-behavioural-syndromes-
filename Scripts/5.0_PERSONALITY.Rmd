...
behav1 <- "response1" #previously inter_key[2]
behav2 <- "response2" #previously inter_key[3]
...
mean_rpt1 <- mean(rpt1)
mean_rpt2 <- mean(rpt2)
df <- data.frame(B0_1, B1_1, B2_1, B3_1, B0_2,B1_2,B2_2,B3_2,sigma_ID1,sigma_ID2,cor_ID1_ID2,sigma_e1,sigma_e2,cor_e1_e2,tot_var1,tot_var2,rpt1,rpt2,mean_rpt1,mean_rpt2)
return(df)
}
...
#Function for population parameters and plotting forest plots
```{r}
#y = B0 + fish_ID + B1*treatment + B2*male+ B3*treatment*male 


func_pop_bivar <- function(mod_char){
  mod <- get(mod_char)

    control_female_r1 <- mod$B0_1
    treatment_female_minus_control_female_r1 <- mod$B1_1 
    treatment_female_r1 <- mod$B1_1 + control_female_r1
    control_male_minus_control_female_r1 <- mod$B2_1
    control_male_r1 <- mod$B2_1 + control_female_r1
    treatment_male_r1 <- mod$B0_1 + mod$B1_1 + mod$B2_1 + mod$B3_1
    treatment_male_minus_treatment_female_r1 <- treatment_male_r1 - treatment_female_r1
    treatment_male_minus_control_male_r1 <- treatment_male_r1 - control_male_r1
    
    control_female_r2 <- mod$B0_2
    treatment_female_minus_control_female_r2 <- mod$B1_2 
    treatment_female_r2 <- mod$B1_2 + control_female_r2
    control_male_minus_control_female_r2 <- mod$B2_2
    control_male_r2 <- mod$B2_2 + control_female_r2
    treatment_male_r2 <- mod$B0_2 + mod$B1_2 + mod$B2_2 + mod$B3_2
    treatment_male_minus_treatment_female_r2 <- treatment_male_r2 - treatment_female_r2
    treatment_male_minus_control_male_r2 <- treatment_male_r2 - control_male_r2
    
    correlation_ID <- mod$cor_ID1_ID2
    correlation_resid <- mod$cor_e1_e2
    
df_pop <- data.frame (control_female_r1,treatment_female_r1,treatment_female_minus_control_female_r1,control_male_r1,treatment_male_r1,control_male_minus_control_female_r1,treatment_male_minus_control_male_r1, treatment_male_minus_treatment_female_r1,control_female_r2,treatment_female_r2,treatment_female_minus_control_female_r2,control_male_r2,treatment_male_r2,control_male_minus_control_female_r2,treatment_male_minus_control_male_r2, treatment_male_minus_treatment_female_r2,correlation_ID,correlation_resid)
...
names(data) <- c("mean.post", "ci.lb", "ci.ub")
data$coef <- (row.names(data))
data$variable <- mod_char
data$coef <- factor(data$coef, levels = c("control_female_r1", "treatment_female_r1", "control_male_r1", "treatment_male_r1","treatment_female_minus_control_female_r1", "treatment_male_minus_control_male_r1", "control_male_minus_control_female_r1", "treatment_male_minus_treatment_female_r1","control_female_r2", "treatment_female_r2", "control_male_r2", "treatment_male_r2","treatment_female_minus_control_female_r2", "treatment_male_minus_control_male_r2", "control_male_minus_control_female_r2", "treatment_male_minus_treatment_female_r2","correlation_ID","correlation_resid"))
...
bivar_models #character vector with names of data frames of the bivar model outputs

bivar_list_pop <- lapply(bivar_models, function(x) func_pop_bivar(mod_char = x)) #applying function to all bivar model outputs
names(bivar_list_pop) <- bivar_models #naming the elements of the list
...
func_forest_plots_bivar <- function (variable = bivar_list_pop[1]){
    mod <- bivar_list_pop[[variable]]
...
forest_plots_pop_bivar <- lapply(bivar_models, function(x) func_forest_plots_bivar(variable = x)) 

names(forest_plots_pop_bivar) <- bivar_models

forest_plots_pop_bivar[1]
forest_plots_pop_bivar[2]
forest_plots_pop_bivar[3]
forest_plots_pop_bivar[4]
forest_plots_pop_bivar[5]
```
