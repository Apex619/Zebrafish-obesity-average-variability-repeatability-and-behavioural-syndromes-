...
anxiety_personality_vars <- c("tot_dist_Anxiety", "low_dur_Anxiety", "tot_dist_Activity", "zone_05_dur_Aggression", "zone_05_dur_Predator", "zone_05_dur_Social", "zone_05_dur_Novel")

combinatons <- combn(anxiety_personality_vars, 2) 
```
