...
load("../Models/rpt_social_control_male.Rdata")
load("../Models/rpt_social_treatment_male.Rdata")
load("../Models/rpt_social_control_female.Rdata")
load("../Models/rpt_social_treatment_female.Rdata")
load("../Models/within_between_social_control_male.Rdata")
load("../Models/within_between_social_treatment_male.Rdata")
load("../Models/within_between_social_control_female.Rdata")
load("../Models/within_between_social_treatment_female.Rdata")
load("../Models/rpt_aggression_control_male.Rdata")
load("../Models/rpt_aggression_treatment_male.Rdata")
load("../Models/rpt_aggression_control_female.Rdata")
load("../Models/rpt_aggression_treatment_female.Rdata")
load("../Models/within_between_aggression_control_male.Rdata")
load("../Models/within_between_aggression_treatment_male.Rdata")
load("../Models/within_between_aggression_control_female.Rdata")
load("../Models/within_between_aggression_treatment_female.Rdata")
load("../Models/within_between_novel_control_male.Rdata")
load("../Models/within_between_novel_treatment_male.Rdata")
load("../Models/within_between_novel_control_female.Rdata")
load("../Models/within_between_novel_treatment_female.Rdata")
load("../Models/within_between_predator_control_male.Rdata")
load("../Models/within_between_predator_treatment_male.Rdata")
load("../Models/within_between_predator_control_female.Rdata")
load("../Models/within_between_predator_treatment_female.Rdata")
load("../Models/rpt_post_assay_control_male.Rdata")
load("../Models/rpt_post_assay_treatment_male.Rdata")
load("../Models/rpt_post_assay_control_female.Rdata")
load("../Models/rpt_post_assay_treatment_female.Rdata")
load("../Models/within_between_activity_control_male.Rdata")
load("../Models/within_between_activity_treatment_male.Rdata")
load("../Models/within_between_activity_control_female.Rdata")
load("../Models/within_between_activity_treatment_female.Rdata")
load("../Models/rpt_novel_control_male_sqrt.Rdata")
load("../Models/rpt_novel_treatment_male_sqrt.Rdata")
load("../Models/rpt_novel_control_female_sqrt.Rdata")
load("../Models/rpt_novel_treatment_female_sqrt.Rdata")
load("../Models/rpt_predator_control_male_sqrt.Rdata")
load("../Models/rpt_predator_treatment_male_sqrt.Rdata")
load("../Models/rpt_predator_control_female_sqrt.Rdata")
load("../Models/rpt_predator_treatment_female_sqrt.Rdata")
...
#Control and treatment males and females for Activity phase
Personality_Control_Male_Activity <- subset(Post_assay_Control, Post_assay_Control$Sex == "male")
Personality_Control_Female_Activity <- subset(Post_assay_Control, Post_assay_Control$Sex == "female")
Personality_Treatment_Male_Activity <- subset(Post_assay_Treatment, Post_assay_Treatment$Sex == "male")
Personality_Treatment_Female_Activity <- subset(Post_assay_Treatment, Post_assay_Treatment$Sex == "female")
```


#Activity (Exploration) analysis
```{r}
# #Calculating repeatabilities using custom made functions for males (control and treatment)
# rpt_tot_dist_Activity(Personality_Control_Male_Activity) -> rpt_post_assay_control_male
# save(rpt_post_assay_control_male, file = "../Models/rpt_post_assay_control_male.Rdata")
# rpt_post_assay_control_male
# rpt_tot_dist_Activity(Personality_Treatment_Male_Activity) -> rpt_post_assay_treatment_male
# save(rpt_post_assay_treatment_male, file = "../Models/rpt_post_assay_treatment_male.Rdata")
# rpt_post_assay_treatment_male
# 
# #Calculating repeatabilities using custom made functions for females (control and treatment)
# rpt_tot_dist_Activity(Personality_Control_Female_Activity) -> rpt_post_assay_control_female
# save(rpt_post_assay_control_female, file = "../Models/rpt_post_assay_control_female.Rdata")
# rpt_post_assay_control_female
# rpt_tot_dist_Activity(Personality_Treatment_Female_Activity) -> rpt_post_assay_treatment_female
# save(rpt_post_assay_treatment_female, file = "../Models/rpt_post_assay_treatment_female.Rdata")
# rpt_post_assay_treatment_female
# 
# 
# #Obtaining within-individual and between-individual variance for males (control and treatment)
# 
# rpt_within_tot_dist_Activity(Personality_Control_Male_Activity) -> within_between_activity_control_male
# save(within_between_activity_control_male, file = "../Models/within_between_activity_control_male.Rdata")
# within_between_activity_control_male
# rpt_within_tot_dist_Activity(Personality_Treatment_Male_Activity) -> within_between_activity_treatment_male
# save(within_between_activity_treatment_male, file = "../Models/within_between_activity_treatment_male.Rdata")
# within_between_activity_treatment_male
# 
# #Obtaining within-individual and between-individual variance for females (control and treatment)
# 
# rpt_within_tot_dist_Activity(Personality_Control_Female_Activity) -> within_between_activity_control_female
# save(within_between_activity_control_female, file = "../Models/within_between_activity_control_female.Rdata")
# within_between_activity_control_female
# rpt_within_tot_dist_Activity(Personality_Treatment_Female_Activity) -> within_between_activity_treatment_female
# save(within_between_activity_treatment_female, file = "../Models/within_between_activity_treatment_female.Rdata")
# within_between_activity_treatment_female



#Obtaining differences between repeatabilities of males and females in the control group
Control_activity_boot_male <- unlist_rptr(rpt_post_assay_control_male) #unlisting from the males
Control_activity_boot_female <- unlist_rptr(rpt_post_assay_control_female) #unlisting from the females
activity_diff_control <- difference_boot(Control_activity_boot_male,Control_activity_boot_female) #calculating the difference between males and females in the control group
q_post_assay_control <- quantiles_diff_boot(activity_diff_control) #obtaining 95% CI
m_post_assay_control <- mean(activity_diff_control) #Obtaining mean
m_post_assay_control
q_post_assay_control

#Obtaining differences between repeatabilities of males and females in the treatment group
treatment_activity_boot_male <- unlist_rptr(rpt_post_assay_treatment_male) #unlisting from the males
treatment_activity_boot_female <- unlist_rptr(rpt_post_assay_treatment_female) #unlisting from the females
activity_diff_treatment <- difference_boot(treatment_activity_boot_male,treatment_activity_boot_female) #calculating the difference between males and females in the treatment group
q_post_assay_treatment <- quantiles_diff_boot(activity_diff_treatment) #obtaining 95% CI
m_post_assay_treatment <- mean(activity_diff_treatment) #Obtaining mean
m_post_assay_treatment
q_post_assay_treatment
```
...
# #Calculating repeatabilities using custom made functions for males (control and treatment)
# rpt_zone05_sqrt(Personality_Control_Male_Novel) -> rpt_novel_control_male_sqrt
# save(rpt_novel_control_male_sqrt, file = "../Models/rpt_novel_control_male_sqrt.Rdata")
# rpt_novel_control_male_sqrt
# rpt_zone05_sqrt(Personality_Treatment_Male_Novel) -> rpt_novel_treatment_male_sqrt
# save(rpt_novel_treatment_male_sqrt, file = "../Models/rpt_novel_treatment_male_sqrt.Rdata")
# 
# rpt_novel_treatment_male_sqrt
# 
# #Calculating repeatabilities using custom made functions for females (control and treatment)
# rpt_zone05_sqrt(Personality_Control_Female_Novel) -> rpt_novel_control_female_sqrt
# save(rpt_novel_control_female_sqrt, file = "../Models/rpt_novel_control_female_sqrt.Rdata")
# 
# rpt_novel_control_female_sqrt
# rpt_zone05_sqrt(Personality_Treatment_Female_Novel) -> rpt_novel_treatment_female_sqrt
# save(rpt_novel_treatment_female_sqrt, file = "../Models/rpt_novel_treatment_female_sqrt.Rdata")
# 
# rpt_novel_treatment_female_sqrt
# 
# 
# #Obtaining within-individual and between-individual variance for males (control and treatment)
# 
...
# #Calculating repeatabilities using custom made functions for males (control and treatment)
# rpt_zone05_sqrt(Personality_Control_Male_Predator) -> rpt_predator_control_male_sqrt
# save(rpt_predator_control_male_sqrt, file = "../Models/rpt_predator_control_male_sqrt.Rdata")
# 
# rpt_predator_control_male_sqrt
# rpt_zone05_sqrt(Personality_Treatment_Male_Predator) -> rpt_predator_treatment_male_sqrt
# save(rpt_predator_treatment_male_sqrt, file = "../Models/rpt_predator_treatment_male_sqrt.Rdata")
# 
# rpt_predator_treatment_male_sqrt
# 
# #Calculating repeatabilities using custom made functions for females (control and treatment)
# rpt_zone05_sqrt(Personality_Control_Female_Predator) -> rpt_predator_control_female_sqrt
# save(rpt_predator_control_female_sqrt, file = "../Models/rpt_predator_control_female_sqrt.Rdata")
# 
# rpt_predator_control_female_sqrt
# rpt_zone05_sqrt(Personality_Treatment_Female_Predator) -> rpt_predator_treatment_female_sqrt
# save(rpt_predator_treatment_female_sqrt, file = "../Models/rpt_predator_treatment_female_sqrt.Rdata")
# 
# rpt_predator_treatment_female_sqrt
# 
# 
# #Obtaining within-individual and between-individual variance for males (control and treatment)
# 
