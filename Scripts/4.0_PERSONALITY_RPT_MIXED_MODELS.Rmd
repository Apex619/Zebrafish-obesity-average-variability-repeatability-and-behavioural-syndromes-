...
summary(Model_post1)
Model_post2 <- lme(tot_dist_Activity ~ Group*Sex-1, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Post_assay, na.action=na.exclude) #mixed model with variance structure varIdent
summary(Model_post2)
