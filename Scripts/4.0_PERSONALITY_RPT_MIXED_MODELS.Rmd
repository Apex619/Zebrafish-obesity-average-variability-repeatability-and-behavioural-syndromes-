---
title: "PERSONALITY_RPT_MIXED_MODELS"
output: html_document
---


### Load packages, functions and models
...
load("../Models/rpt_social_control.Rdata")
load("../Models/rpt_social_treatment.Rdata")
load("../Models/within_between_social_control.Rdata")
load("../Models/within_between_social_treatment.Rdata")
load("../Models/rpt_predator_control_sqrt.Rdata")
load("../Models/rpt_predator_treatment_sqrt.Rdata")
load("../Models/within_between_predator_control.Rdata")
load("../Models/within_between_predator_treatment.Rdata")
load("../Models/rpt_novel_control_sqrt.Rdata")
load("../Models/rpt_novel_treatment_sqrt.Rdata")
load("../Models/within_between_novel_control.Rdata")
load("../Models/within_between_novel_treatment.Rdata")
load("../Models/rpt_aggression_control.Rdata")
load("../Models/rpt_aggression_treatment.Rdata")
load("../Models/within_between_aggression_control.Rdata")
load("../Models/within_between_aggression_treatment.Rdata")
load("../Models/rpt_post_assay_control.Rdata")
load("../Models/rpt_post_assay_treatment.Rdata")
load("../Models/within_between_activity_control.Rdata")
load("../Models/within_between_activity_treatment.Rdata")
load("../Models/rpt_social_control.Rdata")
load("../Models/rpt_social_treatment.Rdata")
load("../Models/within_between_social_control.Rdata")
load("../Models/within_between_social_treatment.Rdata")
...
Post_assay_Control <- subset(Post_assay, Post_assay$Group == "Control") 
Post_assay_Treatment <- subset(Post_assay, Post_assay$Group == "Treatment") 
```
...
Exploration (post-assay); total distance traveled
...
# #Custom function just for activity phase
# rpt_tot_dist_Activity <- function(df) {
#   x <- rpt(tot_dist_Activity ~ (1 |  Fish_ID), grname = "Fish_ID", data = df, datatype = "Gaussian", nboot = 10000, npermut = 10000)
# }
# 
# #Calculating repeatabilities using custom made functions
# rpt_tot_dist_Activity(Post_assay_Control) -> rpt_post_assay_control
# save(rpt_post_assay_control, file = "../Models/rpt_post_assay_control.Rdata")
# rpt_post_assay_control
# rpt_tot_dist_Activity(Post_assay_Treatment) -> rpt_post_assay_treatment
# save(rpt_post_assay_treatment, file = "../Models/rpt_post_assay_treatment.Rdata")
# rpt_post_assay_treatment
# 
# #Custom function for wihin between (for activity)
# rpt_within_tot_dist_Activity <- function(df) {
#   rpt(scale(tot_dist_Activity) ~ (1 |  Fish_ID), grname = c("Fish_ID", "Residual"), data = df, datatype = "Gaussian", nboot = 10000, npermut = 10000, ratio = FALSE)
# }
# 
# #Obtaining within-individual and between-individual variance 
# 
# rpt_within_tot_dist_Activity(Post_assay_Control) -> within_between_activity_control
# within_between_activity_control
# save(within_between_activity_control, file = "../Models/within_between_activity_control.Rdata")
# rpt_within_tot_dist_Activity(Post_assay_Treatment) -> within_between_activity_treatment
# save(within_between_activity_treatment, file = "../Models/within_between_activity_treatment.Rdata")
# within_between_activity_treatment

#Obtaining differences between repeatabilities using custom made functions
Control_activity_boot <- unlist_rptr(rpt_post_assay_control)
Treatment_activity_boot <- unlist_rptr(rpt_post_assay_treatment) 
activity_diff <- difference_boot(Control_activity_boot,Treatment_activity_boot)  
q_post_assay <- quantiles_diff_boot(activity_diff) #obtaining 95% CI
m_post_assay <- mean(activity_diff) #Obtaining mean
m_post_assay
q_post_assay

# Calculating difference in variance between control and treatment groups
Model_post1 <- lme(tot_dist_Activity ~ Group*Sex, random = ~ 1| Fish_ID, data = Post_assay, na.action=na.exclude) #mixed model without variance structure
summary(Model_post1)
tab_model(Model_post1)
Model_post2 <- lme(tot_dist_Activity ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Post_assay, na.action=na.exclude) #mixed model with variance structure varIdent
summary(Model_post2)
anova(Model_post1, Model_post2) #calculating difference between two models to find difference in variance
...
# Calculating difference in variance between control and treatment groups
Model_Social1 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, data = Social_ALL, na.action=na.exclude) #mixed model without variance structure
summary(Model_Social1)
tab_model(Model_Social1)

contrasts_social <- emmeans(Model_Social1, c("Group", "Sex"))
pairs(contrasts_social)

e_social <- allEffects(Model_Social1)
print(e_social)
plot(e_social)


Model_Social2 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Social_ALL, na.action=na.exclude) #mixed model with variance structure varIdent
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Social1_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, data = Social_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Social1_speed) -->
<!-- Model_Social2_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Social_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Social1_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, data = Social_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Social1_dist) -->
<!-- Model_Social2_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Social_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
Model_Predator_zone05_2 <- lmer(sqrt(zone_05_dur) ~ Group*Sex + (1 | Fish_ID), data = Predator_ALL) 
tab_model(Model_Predator_zone05_2)
hist(residuals(Model_Predator_zone05_2)) 

# #Calculating repeatabilities using custom made functions
# rpt_zone05_sqrt(Predator_Control) -> rpt_predator_control_sqrt
# save(rpt_predator_control_sqrt, file = "../Models/rpt_predator_control_sqrt.Rdata")
# rpt_predator_control_sqrt
# 
# rpt_zone05_sqrt(Predator_Treatment) -> rpt_predator_treatment_sqrt
# save(rpt_predator_treatment_sqrt, file = "../Models/rpt_predator_treatment_sqrt.Rdata")
# rpt_predator_treatment_sqrt
# 
# #Original rpt
...
# Calculating difference in variance between control and treatment groups
Model_Predator1 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, data = Predator_ALL, na.action=na.exclude) #mixed model without variance structure
summary(Model_Predator1)
tab_model(Model_Predator1)
Model_Predator2 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Predator_ALL, na.action=na.exclude) #mixed model with variance structure varIdent
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Predator1_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, data = Predator_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Predator1_speed) -->
<!-- Model_Predator2_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Predator_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Predator1_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, data = Predator_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Predator1_dist) -->
<!-- Model_Predator2_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Predator_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
# #Calculating repeatabilities using custom made functions
# rpt_zone05_sqrt(Novel_Control) -> rpt_novel_control_sqrt
# save(rpt_novel_control_sqrt, file = "../Models/rpt_novel_control_sqrt.Rdata")
# rpt_novel_control_sqrt
# rpt_zone05_sqrt(Novel_Treatment) -> rpt_novel_treatment_sqrt
# save(rpt_novel_treatment_sqrt, file = "../Models/rpt_novel_treatment_sqrt.Rdata")
# rpt_novel_treatment_sqrt
# 
# #Obtaining within-individual and between-individual variance 
# 
...
# Calculating difference in variance between control and treatment groups
Model_Novel1 <- lme(sqrt(zone_05_dur) ~ Group*Sex, random = ~ 1| Fish_ID, data = Novel_ALL, na.action=na.exclude) #mixed model without variance structure
summary(Model_Novel1)
tab_model(Model_Novel1)
Model_Novel2 <- lme(sqrt(zone_05_dur) ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Novel_ALL, na.action=na.exclude) #mixed model with variance structure varIdent
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Novel1_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, data = Novel_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Novel1_speed) -->
<!-- Model_Novel2_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Novel_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Novel1_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, data = Novel_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Novel1_dist) -->
<!-- Model_Novel2_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Novel_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
summary(Model_Aggression_zone05)
...
# Calculating difference in variance between control and treatment groups
Model_Aggression1 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, data = Aggression_ALL, na.action=na.exclude) #mixed model without variance structure
summary(Model_Aggression1)
tab_model(Model_Aggression1)
Model_Aggression2 <- lme(zone_05_dur ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Aggression_ALL, na.action=na.exclude) #mixed model with variance structure varIdent
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Aggression1_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, data = Aggression_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Aggression1_speed) -->
<!-- Model_Aggression2_speed <- lme(mean_speed ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Aggression_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between control and treatment groups -->
<!-- Model_Aggression1_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, data = Aggression_ALL, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_Aggression1_dist) -->
<!-- Model_Aggression2_dist <- lme(tot_dist ~ Group*Sex, random = ~ 1| Fish_ID, weights = varIdent(form=~1|Group), data = Aggression_ALL, na.action=na.exclude) #mixed model with variance structure varIdent -->
